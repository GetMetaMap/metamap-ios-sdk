...
#ifndef MATISDK_SWIFT_H
#define MATISDK_SWIFT_H
...
SWIFT_CLASS("_TtC7MatiSDK4Mati")
@interface Mati : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Mati * _Nonnull shared;)
+ (Mati * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC7MatiSDK16MatiButtonResult")
@interface MatiButtonResult : NSObject
@property (nonatomic, weak) id <MatiButtonResultDelegate> _Nullable delegate;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) MatiButtonResult * _Nonnull shared;)
+ (MatiButtonResult * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_PROTOCOL("_TtP7MatiSDK24MatiButtonResultDelegate_")
@protocol MatiButtonResultDelegate
...
@interface SocketManager : NSObject <SocketEngineClient>

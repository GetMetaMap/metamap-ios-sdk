...
typedef NS_OPTIONS(NSUInteger, MetaMapSentryIntegrationOption) {
...
@interface MetaMapSentryBaseIntegration : NSObject
...
- (BOOL)shouldBeEnabledWithOptions:(MetaMapSentryOptions *)options;
- (MetaMapSentryIntegrationOption)integrationOptions;

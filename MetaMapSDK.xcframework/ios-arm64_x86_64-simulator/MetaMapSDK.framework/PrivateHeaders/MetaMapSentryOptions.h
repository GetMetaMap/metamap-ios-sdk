...
@class MetaMapSentryDsn, MetaMapSentryMeasurementValue, MetaMapSentryHttpStatusCodeRange, MetaMapSentryScope;

NS_SWIFT_NAME(Options)
@interface MetaMapSentryOptions : NSObject
 ...
 */
@property (nullable, nonatomic, strong) MetaMapSentryDsn *parsedDsn;
 ...
 * @note Default is @c kMetaMapSentryLevelDebug.
 */
@property (nonatomic, assign) MetaMapSentryLevel diagnosticLevel;
...
/**
 * Specifies wether this SDK should send events to MetaMapSentry. If set to @c NO events will be
 * dropped in the client and not sent to MetaMapSentry. Default is @c YES.
 */
@property (nonatomic, assign) BOOL enabled;

/**
 * Controls the flush duration when calling @c MetaMapSentrySDK/close .
 */
@property (nonatomic, assign) NSTimeInterval shutdownTimeInterval;

/**
 * When enabled, the SDK sends crashes to MetaMapSentry.
 * @note Disabling this feature disables the @c MetaMapSentryWatchdogTerminationTrackingIntegration ,
 * because
 * @c MetaMapSentryWatchdogTerminationTrackingIntegration would falsely report every crash as watchdog
 * termination.
 ...
 */
@property (nullable, nonatomic, copy) MetaMapSentryBeforeSendEventCallback beforeSend;

/**
 * This block can be used to modify the event before it will be serialized and sent.
 */
@property (nullable, nonatomic, copy) MetaMapSentryBeforeBreadcrumbCallback beforeBreadcrumb;
 ...
 */
@property (nullable, nonatomic, copy) MetaMapSentryOnCrashedLastRunCallback onCrashedLastRun;
...
/**
 * Indicates the percentage of events being sent to MetaMapSentry.
 ...
 * @note This feature requires the @c MetaMapSentryCrashIntegration being enabled, otherwise it would
 ...
 * get discarded there: https://docs.MetaMapSentry.io/product/relay/options/
 */
 ...
 * connection IP address as the user address. Due to backward compatibility concerns, MetaMapSentry set the
 * IP address to @c {{auto}} out of the box for Cocoa. If you want to stop MetaMapSentry from
 * using the connections IP address, you have to enable Prevent Storing of IP Addresses in your
 * project settings in MetaMapSentry.
 */
 ...
 * https://docs.MetaMapSentry.io/platforms/apple/performance/
 */
 ...
 */
@property (nonatomic) MetaMapSentryScope * (^initialScope)(MetaMapSentryScope *);
 ...
 */
@property (nullable, nonatomic) MetaMapSentryTracesSamplerCallback tracesSampler;
 ...
 * @c NSData, and automatically added MetaMapSentry-trace header to HTTP requests for distributed tracing.
 * @note Default is @c YES.
 */
 ...
 * @see <https://docs.MetaMapSentry.io/platforms/apple/performance/>
 */
 ...
 */
@property (nullable, nonatomic) MetaMapSentryTracesSamplerCallback profilesSampler;
 ...
 * @note The default is @c YES.
 * @see <https://develop.MetaMapSentry.dev/sdk/client-reports/>
 */
 ...
 * @see https://docs.MetaMapSentry.io/platforms/apple/configuration/options/#trace-propagation-targets
 */
 ...
 */
@property (nonatomic, strong) NSArray<MetaMapSentryHttpStatusCodeRange *> *failedRequestStatusCodes;
...
#if MetaMapSentry_HAS_METRIC_KIT

/**
 * @warning This is an experimental feature and may still have bugs.
 * @brief When enabled, the SDK sends @c MXDiskWriteExceptionDiagnostic, @c MXCPUExceptionDiagnostic
 * and
 * @c MXHangDiagnostic to MetaMapSentry. The SDK supports this feature from iOS 15 and later and macOS 12
 * and later because, on these versions, @c MetricKit delivers diagnostic reports immediately, which
 * allows the MetaMapSentry SDK to apply the current data from the scope.
 ...
 * for a call to @c MetaMapSentrySDK.reportFullyDisplayed().
 * @discussion Use this in conjunction with @c enableUIViewControllerTracing.
 * If @c MetaMapSentrySDK.reportFullyDisplayed() is not called, the transaction will finish

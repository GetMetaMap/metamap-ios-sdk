 ...
 * information check https://develop.MetaMapSentry.dev/sdk/event-payloads/debugmeta/#mach-o-images.
 * @todo This class is actually a DebugImage:
 * https://develop.MetaMapSentry.dev/sdk/event-payloads/debugmeta/#debug-images and should be renamed to
 * @c MetaMapSentryDebugImage in a future version.
 */
NS_SWIFT_NAME(DebugMeta)
@interface MetaMapSentryDebugMeta : NSObject <MetaMapSentrySerializable>
...
/**
 * The size of the image in virtual memory. If missing, MetaMapSentry will assume that the image spans up

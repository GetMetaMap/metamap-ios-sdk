...
@interface MetaMapSentryAttachment : NSObject
 ...
 * @param filename The name of the attachment to display in MetaMapSentry.
 */
 ...
 * @param path The path of the file whose contents you want to upload to MetaMapSentry.
 */
...
/**
 * The filename of the attachment to display in MetaMapSentry.
 */

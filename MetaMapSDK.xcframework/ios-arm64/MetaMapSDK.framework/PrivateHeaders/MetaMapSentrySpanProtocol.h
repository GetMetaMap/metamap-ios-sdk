...
@class MetaMapSentrySpanId, MetaMapSentryId, MetaMapSentryTraceHeader, MetaMapSentryMeasurementUnit;

NS_SWIFT_NAME(Span)
@protocol MetaMapSentrySpan <MetaMapSentrySerializable>

/**
 * Determines which trace the Span belongs to.
 */
@property (nonatomic, strong) MetaMapSentryId *traceId;

/**
 * Span id.
 */
@property (nonatomic, strong) MetaMapSentrySpanId *spanId;

/**
 * The id of the parent span.
 */
@property (nullable, nonatomic, strong) MetaMapSentrySpanId *parentSpanId;

/**
 * The sampling decision of the trace.
 */
@property (nonatomic) MetaMapSentrySampleDecision sampled;
 ...
 */
@property (nonatomic) MetaMapSentrySpanStatus status;
 ...
 * @return MetaMapSentrySpan
 */
- (id<MetaMapSentrySpan>)startChildWithOperation:(NSString *)operation
 ...
 * will be applied to the measurement value in the MetaMapSentry product, and the value will be shown as
 * is.
...
- (void)setMeasurement:(NSString *)name
                 value:(NSNumber *)value
                  unit:(MetaMapSentryMeasurementUnit *)unit
 ...
 *  */
- (void)finishWithStatus:(MetaMapSentrySpanStatus)status NS_SWIFT_NAME(finish(status:));

/**
 * Returns the trace information that could be sent as a MetaMapSentry-trace header.
 * @return MetaMapSentryTraceHeader.
 */
- (MetaMapSentryTraceHeader *)toTraceHeader;

...
//
- (long)getLastTimeTicks NS_SWIFT_NAME(getLastTimeTicks());


//
//  double cv::TickMeter::getLastTimeMicro()
//
- (double)getLastTimeMicro NS_SWIFT_NAME(getLastTimeMicro());


//
//  double cv::TickMeter::getLastTimeMilli()
//
- (double)getLastTimeMilli NS_SWIFT_NAME(getLastTimeMilli());


//
//  double cv::TickMeter::getLastTimeSec()
//
- (double)getLastTimeSec NS_SWIFT_NAME(getLastTimeSec());

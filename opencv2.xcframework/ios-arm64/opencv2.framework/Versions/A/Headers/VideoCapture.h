 ...
 *     See cv::VideoCaptureProperties
 */
- (instancetype)initWithSource:(IStreamReader*)source apiPreference:(int)apiPreference params:(IntVector*)params;
 ...
 *     The method first calls VideoCapture::release to close the already opened file or camera.
 */
- (BOOL)openWithStreamReader:(IStreamReader*)source apiPreference:(int)apiPreference params:(IntVector*)params NS_SWIFT_NAME(open(source:apiPreference:params:));
